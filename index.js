...
// ANSWER: I don't think so. This is my attempt, but it's still linear

function getNumbersSquared2(number) {
  let answers2 = []
  for(let i = 0; i < numbers.length; i++) {
    let squareNum = numbers[i]
    let squared2 = Math.pow(squareNum, 2)
    answers2.push(squared2)
  }
  return answers2
}
...
// ANSWER: The functions are dependent upon the string input. Only one parameter is being added. I can't put it into words, but I know it's linear.
